   ...
   public static class Voices
    {
       public static List<Voice> VoiceList;
        ...
        static Voices()
        {
            ...
            VoiceList.Add(new Voice("Olivia", Gender.Female, "en_au", "en_au_olivia_22k_ns.bvcu"));
            VoiceList.Add(new Voice("Tyler", Gender.Male, "en_au", "en_au_hd_tyler_22k_lf.bvcu"));
            ...
            VoiceList.Add(new Voice("Rhona", Gender.Female, "gd_GB", "en_sct_hd_rhona_22k_lf.bvcu"));
            ...
            VoiceList.Add(new Voice("Kal", Gender.Male, "swe", "gb_se_hd_kal_22k_lf.bvcu"));
            ...
            VoiceList.Add(new Voice("Elias", Gender.Male, "no", "non_elias_22k_ns.bvcu"));
            VoiceList.Add(new Voice("Kari", Gender.Female, "no", "non_hd_kari_22k_lf.bvcu"));
            VoiceList.Add(new Voice("Emilie", Gender.Female, "no", "non_emilie_22k_ns.bvcu"));
            VoiceList.Add(new Voice("Bente", Gender.Female, "no", "non_hd_bente_22k_lf.bvcu"));
            VoiceList.Add(new Voice("Olav", Gender.Male, "no", "non_hd_olav_22k_lf.bvcu"));
            ...
            VoiceList.Add(new Voice("Mia", Gender.Female, "swe", "sc_se_hd_mia_22k_lf.bvcu"));
